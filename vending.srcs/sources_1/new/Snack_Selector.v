...
module Snack_Selector(reset, snack, snack_display_out,
                      cost_out_bin, cost_display_out
    );
    
    input reset, snack;
    output reg [15:0] snack_display_out;
    output reg [15:0] cost_display_out;
    ...
    always @ (*) begin
      case(curr_state)
        s0: begin
          ...
          cost_display_out = 16'b1100000100000000;    // C100
        end
        ...
        s2: begin
          ...
          cost_display_out=16'b1100000001110101;     // C075
        end
        ...
        s3:begin
          ...
          cost_display_out=16'b1100000100100101;     // C125
        end
